...
#import "NoteModel.h"
@implementation NoteDetailTableViewCell
{
...
-(void)setNoteModel:(NoteModel *)noteModel{
    ...
    if(imageUrl.length>0){
        ...
        [_showImageView sd_setImageWithURL:[NSURL URLWithString:noteModel.photo[@"url"]] placeholderImage:[UIImage imageNamed:@"MyTripCellPhotoPlaceholder"]];
